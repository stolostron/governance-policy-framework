...
4. **After the prow configurations are updated, so that the prow jobs are triggered on the new
...
5. Check that fast-forwarding is re-enabled (the `FAST_FORWARD` GitHub Actions variable in this
