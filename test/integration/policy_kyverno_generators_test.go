...
var _ = Describe("GRC: [P1][Sev1][policy-grc] Test the kyverno generator policies", Label("policy-collection", "stable"), func() {
	...
	Describe("Test stable kyverno generator policies", func() {
	...
	Describe("Cleanup all kyverno test resources", func() {
		It("Cleans up", func() {
			// delete the policies
