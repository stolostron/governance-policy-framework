...
var _ = Describe(
	"GRC: [P1][Sev1][policy-grc] Test the ACM Hardening generated PolicySet in an App subscription",
	...
	func() {
		...
		It("Sets up the application subscription", func() {
			...
			By("Checking that the policy reports configuration policy was created in " +
				"the local-cluster namespace")
