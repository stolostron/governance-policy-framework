...
var _ = Describe(
	"RHACM4K-2222 GRC: [P1][Sev1][policy-grc] Test compliance operator and scan",
	...
	func() {
		...
		BeforeEach(func() {
			...
			if !canCreateOpenshiftNamespaces() {
				Skip("Skipping as compliance operator requires the ability " +
					"to create the openshift-compliance namespace")
			}
